...
import { confirmLeave } from "../global";
import { showModal } from "../modal";
import { WMJWTDecode } from "../cookies";
import { getParamFromUrl } from "../helpers";
import { populateUserInfo } from "../populate/userInfo";

export async function handleSubmit(worldMarketApiKey: string, originalCe: CatalogEntry = null): Promise<Result<String>> {
...
export function adjustWidth(element) {
