...
export async function searchCatalogEntries(query: string, pageNumber: number, pageAmount: number, filters: SearchFilters): Promise<Result<CatalogEntry[]>> {
...
export async function fetchCatalogEntry(uuid: string, apiKey?:string): Promise<Result<CatalogEntry>> {
    const result = new Result<CatalogEntry>(false, "An unhandled error occured.", null);
...
export async function fetchAllCatalogEntries(pageNumber: number, pageAmount: number): Promise<Result<CatalogEntry[]>> {
    const result = new Result<CatalogEntry[]>(false, "An unhandled error occured.", null);
...
export async function fetchCatalogEntriesFromSeller(sellerUuid: string, pageNumber: number, pageAmount: number, showOnlyActive: boolean, showOnlyInactive: boolean, apiKey?: string): Promise<Result<CatalogEntry[]>> {
    const result = new Result<CatalogEntry[]>(false, "An unhandled error occured.", null);
