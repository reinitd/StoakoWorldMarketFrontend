...
export async function fetchUser(uuid: string): Promise<Result<User>> {
...
export async function updateUser(userToUpdate: User, worldMarketApiKey: string): Promise<Result> {
