...
export class McAuthProfileResponse {
    uuid: string;
...
export class ExchangeMcAuthResponse {
    isNewUser: boolean;
...
export async function exchangeMcAuthCode(code: string): Promise<Result<ExchangeMcAuthResponse>> {
...
export async function revokeJwt(confirm: boolean) : Promise<Result> {
