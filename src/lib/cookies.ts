...
export function setCookie(cookieName: string, cookieValue: string, cookieExp: Date) {
...
export interface WMJWTHeader {
    alg: string;
    typ: string;
}

export interface WMJWTPayload {
    username: string;
    uuid: string;
    role: string;
    exp: string;
...
export function WMJWTDecode(jwt: string): WorldMarketJWT {
